  ...
  return (
    <>
      ...
      <section className="max-w-6xl mx-auto px-4 py-10">
        <div className="relative rounded-2xl overflow-hidden bg-white border-b border-grace">
          <Image
      ...
      <section className="max-w-6xl mx-auto px-4 pb-12">
        <h2 className="text-2xl font-bold text-scripture mb-6">All 613 Commandments</h2>
