      ...
      <nav className="bg-white border-b border-grace">
        <div className="max-w-6xl mx-auto px-4 py-3">
          <ol className="flex items-center text-sm">
            ...
            <li className="text-ink-muted">Chain Studies</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
          ...
          <div className="flex flex-wrap gap-6 text-center">
            <div>
              ...
              <p className="text-xs text-ink-muted uppercase tracking-wider">Chain Studies</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-scripture">{stats.totalVerses.toLocaleString()}</p>
              <p className="text-xs text-ink-muted uppercase tracking-wider">Total Verses</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-scripture">{stats.averageBooks}</p>
              <p className="text-xs text-ink-muted uppercase tracking-wider">Avg. Books Per Chain</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {featured.map(chain => (
              ...
              >
                <p className="font-semibold text-scripture group-hover:text-gold-dark transition-colors mb-2">
                  {chain.subject}
                </p>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="inline-block px-1.5 py-0.5 rounded text-xs bg-blue-50 text-scripture border border-sacred/10">
              ...
              return (
                <div key={letter} id={`section-${letter}`}>
                  <div className="flex items-center gap-3 mb-3 border-b border-grace pb-2">
                    ...
                    <span className="text-sm text-ink-light">{count} chains</span>
                  </div>
