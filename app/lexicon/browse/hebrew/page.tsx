        ...
        <div className="bg-[#FAFAF9] pb-32 min-h-screen">
            ...
            <div className="bg-white/40 border-b border-grace backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
                    <Link href="/lexicon" className="group flex items-center text-ink-muted hover:text-rose-600 transition-all text-[11px] font-bold uppercase">
                            ...
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-8">
                                        <span className="text-[11px] font-bold text-ink-light uppercase group-hover:text-rose-600 transition-colors">{entry.strongs}</span>
                                        <div className="w-8 h-8 rounded-xl bg-primary-light/30 flex items-center justify-center text-ink-light group-hover:bg-rose-50 group-hover:text-rose-400 transition-all">
                        ...
                        <div className="mt-24 flex items-center justify-center space-x-12">
                            {currentPage > 1 ? (
                                <Link
                                    ...
                                    className="group flex items-center text-[11px] font-bold uppercase tracking-[0.2em] text-ink-muted hover:text-rose-600 transition-all"
                                >
            ...
            <section className="py-32 px-4">
                <div className="max-w-5xl mx-auto glass-panel p-20 rounded-[64px] border border-grace/50 bg-scripture text-center relative overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-br from-scripture/40 via-transparent to-transparent -z-10" />
                    <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tighter">Shift to <span className="text-sacred italic">Greek.</span></h2>
                    ...
                    <Link href="/lexicon/browse/greek" className="btn-premium px-12 py-6 bg-scripture text-white rounded-[32px] text-sm font-bold uppercase shadow-2xl hover:scale-105 transition-all inline-flex items-center group/btn">
