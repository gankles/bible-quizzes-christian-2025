        ...
        <div className="bg-[#FAFAF9] pb-32 min-h-screen">
            ...
            <div className="bg-white/40 border-b border-grace backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
                    <Link href="/lexicon" className="group flex items-center text-primary-dark/60 hover:text-amber-600 transition-all text-[11px] font-bold uppercase">
                            ...
                            >
                                <div>
                                    <div className="flex items-center justify-between mb-8">
                                        <span className="text-[11px] font-bold text-primary-dark/40 uppercase group-hover:text-amber-600 transition-colors">{entry.strongs}</span>
                                        <div className="w-8 h-8 rounded-xl bg-primary-light/30 flex items-center justify-center text-primary-dark/40 group-hover:bg-primary-light group-hover:text-blue-400 transition-all">
                                            <BookOpenIcon className="w-4 h-4" />
                                        </div>
                                    </div>
                                    <div className="text-4xl font-bold text-scripture mb-3 tracking-tighter group-hover:text-blue-600 transition-colors">
                                        {entry.word}
                                    </div>
                        ...
                        <div className="mt-24 flex items-center justify-center space-x-12">
                            {currentPage > 1 ? (
                                <Link
                                    ...
                                    className="group flex items-center text-[11px] font-bold uppercase tracking-[0.2em] text-primary-dark/60 hover:text-amber-600 transition-all"
                                >
