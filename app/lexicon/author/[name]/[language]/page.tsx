        ...
        <div className="bg-[#FAFAF9] pb-32 min-h-screen">
            ...
            <div className="bg-primary-light/30 border-b border-grace">
                <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
                    <Link href="/lexicon" className="group flex items-center text-primary-dark/60 hover:text-blue-600 transition-all text-[10px] font-bold uppercase">
            ...
            <section className="py-32 relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                        <div>
                            <div className="inline-flex items-center space-x-2 text-primary-dark/40 font-bold text-[10px] uppercase mb-6">
                                <ChartBarIcon className="w-4 h-4 text-blue-600" />
                                <span>Word Frequency Study</span>
                            </div>
                            <h2 className="text-5xl md:text-6xl font-bold text-scripture tracking-tighter uppercase italic">Vocabulary <span className="text-primary-dark/40 not-italic font-light text-4xl">Concentration.</span></h2>
                        </div>
                        <div className="text-[11px] font-bold text-primary-dark/40 uppercase border-l-2 border-grace pl-8 italic">
            ...
            <section className="py-32 bg-primary-light/30 relative overflow-hidden rounded-[80px] mx-8">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-24">
                        <h2 className="text-5xl md:text-7xl font-bold text-scripture mb-8 tracking-tighter uppercase italic">Theological <span className="text-primary-dark/40 not-italic">Signature.</span></h2>
                        <p className="text-xl text-primary-dark/60 max-w-2xl mx-auto font-medium leading-relaxed italic">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {topVocab.map((entry: any) => (
                            <Link
                                ...
                                className="group p-12 rounded-[48px] border border-grace bg-white hover:border-blue-600/30 hover:shadow-2xl transition-all duration-700 h-full flex flex-col justify-between"
                            >
                                <div>
                                    <div className="flex items-start justify-between mb-10">
                                        <div className={`px-4 py-1.5 rounded-lg bg-primary-light/30 border border-grace text-blue-600 text-[10px] font-bold uppercase`}>
                                            {entry.strongs}
                                        </div>
                                        <div className="text-[10px] font-bold text-primary-dark/20 uppercase group-hover:text-scripture transition-colors italic">
                                            Usage Frequency: {entry.authorUsage}x
                                        </div>
                                    </div>
                                    <div className={`text-6xl font-bold text-scripture mb-4 tracking-tighter uppercase italic group-hover:text-blue-600 transition-colors ${author.language === 'hebrew' ? 'text-right' : ''}`} dir={author.language === 'hebrew' ? 'rtl' : 'ltr'}>
                                        {entry.word}
                                    </div>
                                    <div className="text-[11px] font-bold text-primary-dark/40 uppercase tracking-[0.2em] mb-6 italic">
                                        {entry.transliteration}
                                    </div>
                                    <p className="text-primary-dark/60 font-medium leading-relaxed text-base mb-12 italic border-l-2 border-grace/50 pl-6">
            ...
            <section className="py-40 relative px-4 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h3 className="text-4xl md:text-6xl font-bold text-scripture mb-10 tracking-tighter uppercase italic">Scholarly <span className="text-primary-dark/40 not-italic font-light">Focus.</span></h3>
                    <p className="text-xl text-primary-dark/60 mb-16 max-w-2xl mx-auto font-medium leading-relaxed italic border-l-4 border-sacred pl-8">
                        "While the frequency of a word is measurable, the **scriptural context** defines the soul of the apostolic message."
                    </p>
                    <Link href="/lexicon" className="px-12 py-6 bg-scripture text-white rounded-xl text-[10px] font-bold uppercase shadow-2xl hover:bg-primary-dark/60 transition-all inline-flex items-center group">
