          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-wrap gap-6 text-center">
              <div>
                ...
                <p className="text-xs text-ink-light uppercase tracking-wider">Plans</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-scripture">{stats.totalReadings.toLocaleString()}</p>
                <p className="text-xs text-ink-light uppercase tracking-wider">Total Readings</p>
              </div>
              <div>
                <p className="text-3xl font-bold text-scripture">{stats.categories.length}</p>
                <p className="text-xs text-ink-light uppercase tracking-wider">Categories</p>
              </div>
            </div>
          </div>
        </div>
                ...
                {categoryPlans.map(plan => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-medium text-sacred bg-blue-50 px-2.5 py-1 rounded-full">
