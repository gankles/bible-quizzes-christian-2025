        ...
        <nav className="bg-white border-b border-grace">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <ol className="flex items-center text-sm">
              ...
              <li className="text-ink-muted">Red Letter Verses</li>
            </ol>
          </div>
        </nav>
        ...
        <main className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-white border border-grace rounded-lg p-4 text-center">
              ...
              <div className="text-xs text-ink-muted mt-1">Books</div>
            </div>
            <div className="bg-white border border-grace rounded-lg p-4 text-center">
              <div className="text-2xl font-bold text-red-600">KJV</div>
              <div className="text-xs text-ink-muted mt-1">Translation</div>
            </div>
          </div>

          {/* Jump Links */}
          <div className="bg-white border border-grace rounded-xl p-4 mb-8">
            <h2 className="text-sm font-semibold text-ink-muted uppercase tracking-wider mb-3">Jump to Book</h2>
