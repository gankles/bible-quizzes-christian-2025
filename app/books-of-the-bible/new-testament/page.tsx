      ...
      <nav aria-label="Breadcrumb" className="bg-white border-b border-grace">
        <div className="max-w-5xl mx-auto px-4 py-3">
          <ol className="flex items-center space-x-2 text-sm">
            ...
            <li aria-hidden="true" className="text-ink-light">/</li>
            <li aria-current="page" className="text-ink-muted">New Testament</li>
          </ol>
        </div>
      </nav>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-grace overflow-hidden mb-8">
          <div className="relative h-48 md:h-56 bg-gradient-to-r from-scripture to-scripture/80">
            <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-8">
              ...
              <p className="text-sacred-light max-w-2xl mb-4">
          ...
          <div className="grid grid-cols-3 divide-x divide-grace border-b border-grace">
            ...
            <div className="p-4 text-center">
              <p className="text-2xl font-bold text-sacred">4</p>
        ...
        <section className="mt-10 bg-white rounded-xl shadow-sm border border-grace p-6 md:p-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-ink-muted leading-relaxed">
                The New Testament contains <strong>{totalChapters.toLocaleString()} chapters</strong> across its 27 books. The Gospels account for 89 chapters, <Link href="/acts-chapters" className="text-sacred hover:underline">Acts</Link> has 28 chapters, the Pauline Epistles have 87 chapters, the General Epistles have 34 chapters, and <Link href="/revelation-chapters" className="text-sacred hover:underline">Revelation</Link> has 22 chapters. The longest New Testament books by chapter count are <Link href="/matthew-chapters" className="text-sacred hover:underline">Matthew</Link> and Acts, both with 28 chapters.
              </p>
            </div>
            <div>
              <h3 className="font-display font-bold text-scripture mb-2">Who wrote the most New Testament books?</h3>
              <p className="text-ink-muted leading-relaxed">
                The Apostle <strong>Paul</strong> wrote the most New Testament books, authoring 13 epistles: <Link href="/romans-chapters" className="text-sacred hover:underline">Romans</Link>, <Link href="/1-corinthians-chapters" className="text-sacred hover:underline">1 Corinthians</Link>, <Link href="/2-corinthians-chapters" className="text-sacred hover:underline">2 Corinthians</Link>, <Link href="/galatians-chapters" className="text-sacred hover:underline">Galatians</Link>, <Link href="/ephesians-chapters" className="text-sacred hover:underline">Ephesians</Link>, <Link href="/philippians-chapters" className="text-sacred hover:underline">Philippians</Link>, <Link href="/colossians-chapters" className="text-sacred hover:underline">Colossians</Link>, 1 &amp; 2 Thessalonians, 1 &amp; 2 Timothy, <Link href="/titus-chapters" className="text-sacred hover:underline">Titus</Link>, and <Link href="/philemon-chapters" className="text-sacred hover:underline">Philemon</Link>. Paul&rsquo;s letters make up nearly half of the 27 New Testament books. The Apostle John is the second most prolific NT author with 5 books (the Gospel of John, 1-3 John, and Revelation).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-8 bg-white rounded-xl shadow-sm border border-grace p-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
            ...
            <Link href="/books-of-the-bible/old-testament" className="flex items-center p-3 border border-grace rounded-lg hover:border-sacred/50 hover:bg-primary-light transition-colors">
              <span className="text-sacred font-medium text-sm">Old Testament Books</span>
            </Link>
            <Link href="/new-testament-quizzes" className="flex items-center p-3 bg-scripture text-white rounded-lg hover:bg-ink-muted transition-colors">
