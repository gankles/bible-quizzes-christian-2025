  ...
  return (
    <>
      ...
      <nav className="max-w-6xl mx-auto px-4 pt-4 text-sm text-gray-500">
        ...
        <span className="text-gray-900 font-medium">Bible Names</span>
      </nav>
        ...
        <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-wrap gap-6 text-center">
              <div>
                <p className="text-3xl font-bold">{allNames.length.toLocaleString()}</p>
                <p className="text-xs text-gray-400 uppercase tracking-wider">Names</p>
              </div>
              <div>
                <p className="text-3xl font-bold">{letters.length}</p>
                <p className="text-xs text-gray-400 uppercase tracking-wider">Letters</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 pb-12">
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/bible-book-names" className="px-5 py-2.5 bg-white text-blue-600 text-sm font-medium rounded-lg border border-blue-300 hover:bg-blue-50 transition-colors">
              Bible Book Names
            </Link>
            <Link href="/commandments" className="px-5 py-2.5 bg-white text-gray-700 text-sm font-medium rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors">
              613 Commandments
            </Link>
          </div>
        </div>
