            ...
            <div className="max-w-7xl mx-auto px-4 md:px-10 -mt-8">
                <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto">
                    <div className="bg-white rounded-lg border border-grace shadow-sm p-5 text-center">
                        ...
                        <div className="text-xs font-bold uppercase text-primary-dark/40 mt-1">Total Words</div>
                    </div>
                    <div className="bg-white rounded-lg border border-grace shadow-sm p-5 text-center">
                        <div className="text-3xl font-bold text-blue-600">{greekWords.length}</div>
                        <div className="text-xs font-bold uppercase text-primary-dark/40 mt-1">Greek</div>
                    </div>
                    <div className="bg-white rounded-lg border border-grace shadow-sm p-5 text-center">
                        <div className="text-3xl font-bold text-amber-600">{hebrewWords.length}</div>
                        <div className="text-xs font-bold uppercase text-primary-dark/40 mt-1">Hebrew</div>
                    </div>
                </div>
            </div>
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-10 py-16">
                ...
                {greekWords.length > 0 && (
                    <div className="mb-16">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <span className="text-sm text-primary-dark/40 font-medium">{greekWords.length} words</span>
                        </div>
                ...
                {hebrewWords.length > 0 && (
                    <div className="mb-16">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <div className="flex-1 h-px bg-grace"></div>
                            <span className="text-sm text-primary-dark/40 font-medium">{hebrewWords.length} words</span>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {totalWords === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-primary-dark/60">Word studies are being prepared. Check back soon.</p>
                    </div>
                )}
            </main>
            ...
            <section className="bg-primary-light/30 border-t border-grace py-16">
                <div className="max-w-7xl mx-auto px-4 md:px-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <Link
                            href="/lexicon"
                            className="group bg-white rounded-lg border border-grace p-6 hover:border-blue-300 hover:shadow-lg transition-all duration-300"
                        >
                            ...
                            <h3 className="font-bold text-scripture group-hover:text-blue-600 transition-colors mb-1">
                                Biblical Lexicon
                            </h3>
...
function WordCard({ word }: { word: any }) {
    ...
    return (
        <Link
            ...
            className="group bg-white rounded-lg border border-grace p-6 hover:border-blue-300 hover:shadow-xl transition-all duration-300 flex flex-col"
        >
            {/* Language Badge */}
            <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-mono text-primary-dark/40">{word.strongsNumber}</span>
            </div>

            {/* Original Word */}
            <div className="mb-3">
                <div className="text-3xl font-bold text-scripture group-hover:text-blue-600 transition-colors leading-tight">
                    {word.word}
                </div>
            </div>
            ...
            <div className="mb-4">
                <span className="text-sm font-semibold text-primary-dark/80">{word.transliteration}</span>
                {word.pronunciation && (
                    <span className="text-sm text-primary-dark/40 ml-2">/{word.pronunciation}/</span>
                )}
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-grace/50">
                <div className="text-xs text-primary-dark/40">
                    <span className="font-bold text-primary-dark/70">{word.usageCount}</span> occurrences in Scripture
                </div>
