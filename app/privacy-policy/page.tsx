  ...
  return (
    <div className="bg-[#FAFAF9] min-h-screen pb-24">
      <div className="max-w-3xl mx-auto px-6 pt-16">
        <h1 className="text-4xl font-bold font-display text-scripture mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-ink-muted leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Overview</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Information We Collect</h2>
            ...
            <p className="mb-3"><strong className="text-scripture">Automatically collected data:</strong> When you visit our site, our hosting provider may collect standard server logs including IP addresses, browser type, referring pages, and pages visited. This data is used solely for maintaining site performance and security.</p>
            <p><strong className="text-scripture">Cookies:</strong> We may use cookies for basic site functionality and analytics. No advertising cookies or third-party tracking cookies are used.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Data Sharing</h2>
            <p>We do not sell, trade, or share your personal information with third parties. We do not serve targeted advertising.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Third-Party Services</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Children&apos;s Privacy</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Changes to This Policy</h2>
            <p>We may update this privacy policy from time to time. Changes will be posted on this page with an updated revision date.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Contact</h2>
            <p>If you have questions about this privacy policy, please visit our <a href="/contact" className="text-sacred hover:text-gold-dark underline">contact page</a>.</p>
          </section>
        </div>
      </div>
    </div>
