    ...
    <div className="bg-[#FAFAF9] min-h-screen pb-24">
      <div className="max-w-3xl mx-auto px-6 pt-16">
        ...
        <div className="space-y-8 text-primary-dark/70 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Use of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Content &amp; Accuracy</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Limitation of Liability</h2>
            <p>Bible Maximum shall not be liable for any damages arising from the use or inability to use this service.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-scripture mb-3">Changes to Terms</h2>
