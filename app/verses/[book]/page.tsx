                ...
                <section className="relative py-24 overflow-hidden border-b border-grace/50 bg-white">
                    ...
                    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold text-scripture mb-8 tracking-tighter leading-tight uppercase italic">
                            {verse1.bookName} {verse1.chapter}:{verse1.verse} <span className="text-sacred not-italic font-light">&</span> {verse2.bookName} {verse2.chapter}:{verse2.verse}
                        </h1>
                ...
                <section className="py-24 max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-24">
                        <div className="group p-12 md:p-16 rounded-xl border border-grace/50 bg-white shadow-xl relative overflow-hidden transition-all duration-700 hover:-translate-y-1">
                            <div className="text-[10px] font-bold text-ink-muted uppercase  mb-10">Passage I: {verse1.bookName}</div>
                            <p className="text-2xl md:text-3xl font-bold text-scripture leading-[1.4] italic uppercase border-l-4 border-grace/50 group-hover:border-sacred/50 transition-colors pl-10">
                                "{verse1.text}"
                            </p>
                            <div className="mt-12 flex items-center justify-between">
                                <span className="text-[10px] font-bold text-scripture/20 uppercase">{verse1.translation} Standard</span>
                                <Link href={`/verses/${verse1.book}/${verse1.chapter}/${verse1.verse}`} className="text-[10px] font-bold text-sacred uppercase opacity-0 group-hover:opacity-100 transition-all flex items-center">
                        ...
                        <div className="group p-12 md:p-16 rounded-xl border border-grace/50 bg-white shadow-xl relative overflow-hidden transition-all duration-700 hover:-translate-y-1">
                            <div className="text-[10px] font-bold text-ink-muted uppercase  mb-10">Passage II: {verse2.bookName}</div>
                            <p className="text-2xl md:text-3xl font-bold text-scripture leading-[1.4] italic uppercase border-l-4 border-grace/50 group-hover:border-sacred/50 transition-colors pl-10">
                                "{verse2.text}"
                            </p>
                            <div className="mt-12 flex items-center justify-between">
                                <span className="text-[10px] font-bold text-scripture/20 uppercase">{verse2.translation} Standard</span>
                                <Link href={`/verses/${verse2.book}/${verse2.chapter}/${verse2.verse}`} className="text-[10px] font-bold text-sacred uppercase opacity-0 group-hover:opacity-100 transition-all flex items-center">
                                    Full Study <ArrowRightIcon className="w-4 h-4 ml-2" />
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                        <div className="lg:col-span-8">
                            <div className="p-12 md:p-20 rounded-[48px] bg-scripture text-white shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="flex items-center space-x-6 mb-12">
                                    <div className="w-16 h-16 rounded-lg bg-scripture flex items-center justify-center text-white shadow-2xl group-hover:rotate-12 transition-transform">
                        ...
                        <div className="lg:col-span-4">
                            <div className="p-12 rounded-xl bg-white border border-grace/50 shadow-xl">
                                <h3 className="text-xl font-bold mb-8 uppercase text-sacred italic">Study Metadata</h3>
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-between border-b border-grace/50 pb-4">
                                        ...
                                        <span className="text-sacred font-bold italic">Foundational</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="bg-[#FAFAF9] pb-32 min-h-screen">
                ...
                <section className="relative py-24 overflow-hidden border-b border-grace/50 bg-white">
                    ...
                    <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
                        ...
                        <h1 className="text-6xl md:text-8xl font-bold text-scripture mb-8 tracking-tighter leading-tight uppercase italic">
                            The Book of <span className="text-sacred not-italic font-light">{bookData.name}</span>
                        </h1>
                ...
                <main className="max-w-7xl mx-auto px-6 py-24">
                    <div className="flex items-center justify-between mb-16">
                        <h2 className="text-4xl font-bold text-scripture tracking-tight uppercase italic">Navigate <span className="text-sacred/30 not-italic font-light text-3xl">Chapters.</span></h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-6">
                        {Array.from({ length: bookData.chapters }, (_, i) => i + 1).map((chapterNum) => (
                            ...
                            >
                                <span className="text-[9px] font-bold text-ink-muted uppercase mb-1 group-hover:text-gold-dark">CH</span>
