        ...
        <nav className="bg-white border-b border-grace">
          <div className="max-w-4xl mx-auto px-4 py-3">
            <ol className="flex items-center flex-wrap gap-y-1 text-sm">
              ...
              <li><Link href="/characters" className="text-sacred hover:underline">Characters</Link></li>
              <li className="text-ink-light mx-2">/</li>
              <li><Link href="/characters-by-topic" className="text-sacred hover:underline">By Topic</Link></li>
              <li className="text-ink-light mx-2">/</li>
        ...
        <section className="py-12 bg-gradient-to-b from-scripture to-primary-light/30">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-4xl font-bold font-display text-scripture mb-3">
              Bible Characters Related to <span className="text-sacred">{name}</span>
            </h1>
        ...
        <main className="max-w-4xl mx-auto px-4 pb-12">
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-ink-light">Relevance: {char.relevance}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Link
                      ...
                      className="text-xs text-sacred hover:underline font-medium"
                    >
                      Biography
                    </Link>
          ...
          <div className="bg-blue-50 border border-sacred/20 rounded-xl p-5 mb-8 flex items-center justify-between flex-wrap gap-3">
            <div>
              ...
              <p className="text-sm text-ink-muted">Read what the Bible says about this topic.</p>
            </div>
            <Link
              href={`/topics/${topic}`}
          ...
          <section className="bg-grace/10 border border-grace rounded-xl p-6">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <Link href={`/topics/${topic}`} className="text-sacred hover:underline text-sm">
                {name} Topic Page
              </Link>
              ...
              {relatedSlugs.map(rs => (
                <Link key={rs} href={`/characters-by-topic/${rs}`} className="text-sacred hover:underline text-sm">
