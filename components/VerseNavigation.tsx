...
export function VerseNavigation({ currentBook, currentChapter, currentVerse, bookName }: VerseNavigationProps) {
    ...
    return (
        <nav className="flex flex-col md:flex-row items-center justify-between gap-6 py-12 border-t border-gray-100 mt-20" aria-label="Study Navigation">
            {/* PREVIOUS NODE */}
            {prevVerse && !prevVerse.disabled ? (
                ...
                >
                    <div className="w-12 h-12 rounded-lg bg-gray-900 text-white flex items-center justify-center group-hover:bg-blue-600 transition-colors shadow-lg">
                        <ChevronLeftIcon className="w-6 h-6 group-hover:-translate-x-1 transition-transform" />
                    </div>
                    <div className="text-left">
                        <div className="text-[10px] font-bold text-gray-400 uppercase mb-1">Previous Verse</div>
                        <div className="text-lg font-bold text-gray-950 tracking-tight">{prevVerse.label}</div>
                    </div>
                </Link>
            ) : (
                <div className="w-full md:w-auto flex items-center gap-6 glass-panel p-6 pr-10 rounded-[32px] border border-dashed border-gray-200 bg-gray-50 opacity-40 grayscale">
                    <div className="w-12 h-12 rounded-lg bg-gray-200 text-gray-400 flex items-center justify-center">
                        <ChevronLeftIcon className="w-6 h-6" />
                    </div>
                    <div className="text-left">
                        <div className="text-[10px] font-bold text-gray-400 uppercase mb-1">First Verse</div>
                        <div className="text-lg font-bold text-gray-400 tracking-tight">Genesis 1:1</div>
                    </div>
                </div>
            )}
            ...
            <Link
                ...
                className="btn-premium px-10 py-5 bg-gray-950 text-white rounded-full text-[11px] font-bold uppercase tracking-[0.2em] shadow-2xl hover:scale-105 transition-all flex items-center group"
            >
            ...
            {nextVerse && !nextVerse.disabled ? (
                ...
                >
                    <div className="text-right">
                        <div className="text-[10px] font-bold text-gray-400 uppercase mb-1">Next Verse</div>
                        <div className="text-lg font-bold text-gray-950 tracking-tight">{nextVerse.label}</div>
                    </div>
                    <div className="w-12 h-12 rounded-lg bg-gray-900 text-white flex items-center justify-center group-hover:bg-blue-600 transition-colors shadow-lg">
                ...
                <div className="w-full md:w-auto flex items-center justify-end gap-6 glass-panel p-6 pl-10 rounded-[32px] border border-dashed border-gray-200 bg-gray-50 opacity-40 grayscale">
                    <div className="text-right">
                        <div className="text-[10px] font-bold text-gray-400 uppercase mb-1">Last Verse</div>
                        <div className="text-lg font-bold text-gray-400 tracking-tight">Canon End</div>
                    </div>
                    <div className="w-12 h-12 rounded-lg bg-gray-200 text-gray-400 flex items-center justify-center">
