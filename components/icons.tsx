...
// Temporary icon components until Heroicons is installed
...
export const MessageSquareIcon = ({ className = "w-6 h-6" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
  </svg>
);

export const BarChartIcon = ({ className = "w-6 h-6" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const MegaphoneIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.056.51.107.76.154m2.28-4.59a5.25 5.25 0 1110.5 0 5.25 5.25 0 01-10.5 0zm-8.28 4.59a4.5 4.5 0 01-4.5-4.5V11.25a4.5 4.5 0 014.5-4.5m0 9.18c.253.056.51.107.76.154m1.12-9.255a23.931 23.931 0 012.305-.353c.111-.013.224-.024.336-.033m-2.641 9.641c.253.056.51.107.76.154m1.12 3.541c.21.03.419.058.63.084m0 0l.33.042m-1.12-3.667a23.922 23.922 0 002.306.353c.111.013.224.024.336.033m3.025-4.496l1.32.134m-1.32-.134l1.32.134" />
  </svg>
);
...
export const SunIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.243l-1.591 1.591M3 12h2.25m.386-6.364l1.591 1.591M12 7.5a4.5 4.5 0 110 9 4.5 4.5 0 010-9z" />
  </svg>
);
...
export const FingerPrintIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.568 8.263M14.586 3.136A9.985 9.985 0 0012 3C7.029 3 3 7.029 3 12c0 2.226.806 4.265 2.136 5.864m11.144-11.144A7.476 7.476 0 0012 4.5c-4.142 0-7.5 3.358-7.5 7.5 0 1.104.239 2.152.666 3.098m10.155-10.155A4.476 4.476 0 0012 6c-3.314 0-6 2.686-6 6 0 .828.168 1.617.472 2.338m7.528-7.528A2.976 2.976 0 0012 7.5a2.25 2.25 0 00-2.25 2.25M12 11.25v5.25" />
  </svg>
);

export const TreeIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V11m0 0L7 6m5 5l5-5m-5 10l-3-3m3 3l3-3" />
  </svg>
);

export const ActivityIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12h3.375l2.25-4.5 2.25 9 2.25-9 2.25 9 2.25-4.5h3.375" />
  </svg>
);
