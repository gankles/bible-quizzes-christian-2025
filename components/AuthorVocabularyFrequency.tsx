    ...
    return (
        <div className="relative group">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className={`text-5xl font-bold mb-4 tracking-tighter text-scripture group-hover/card:text-sacred transition-colors ${language === 'hebrew' ? 'text-right' : ''}`} dir={language === 'hebrew' ? 'rtl' : 'ltr'}>
                                    {entry.word}
                                </div>
                                <div className="text-[10px] font-bold text-scripture/40 uppercase tracking-[0.2em] mb-2 italic">
                                    {entry.strongs}
                                </div>
                                <div className={`inline-flex items-center px-3 py-1 rounded-lg bg-primary-light/30 text-ink-muted text-[9px] font-bold uppercase border border-primary-dark/5`}>
                            ...
                            <div className="absolute inset-x-2 bottom-2 top-2 opacity-0 group-hover/card:opacity-100 transition-all duration-500 transform translate-y-4 group-hover/card:translate-y-0 z-20">
                                <div className="h-full w-full rounded-[32px] bg-scripture p-6 flex flex-col items-center justify-center text-white shadow-3xl">
                                    <div className="text-sacred text-[10px] font-bold uppercase tracking-[0.2em] mb-3 italic">
                                    ...
                                    <div className="flex items-center text-[9px] font-bold uppercase text-sacred">
            ...
            <div className="mt-20 flex flex-wrap gap-12 items-center justify-center border-t border-primary-dark/10 pt-12">
                ...
                <div className="flex items-center space-x-3">
                    <div className={`w-4 h-4 rounded-lg opacity-40 bg-scripture shadow-lg`} />
                    <span className="text-[10px] font-bold text-scripture/40 uppercase italic">Moderate</span>
                </div>
                <div className="flex items-center space-x-3">
                    <div className={`w-4 h-4 rounded-lg bg-scripture shadow-xl`} />
