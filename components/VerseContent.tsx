                    ...
                    <div className="space-y-16">
                        ...
                        {content.context && (
                            <div className="p-12 md:p-20 rounded-[64px] border border-grace/50 bg-white shadow-3xl relative overflow-hidden">
                                <div className="absolute top-0 right-0 w-64 h-64 bg-scripture/5 blur-[100px] -z-10" />
                                <div className="flex items-center space-x-4 mb-10">
                                    <div className="w-12 h-12 rounded-lg bg-scripture flex items-center justify-center text-sacred shadow-xl">
                                        <BookOpenIcon className="w-6 h-6" />
                                    </div>
                                    <h2 className="text-3xl font-bold tracking-tighter uppercase italic">Historical <span className="text-ink-light not-italic font-light">Focus.</span></h2>
                                </div>
                                <p className="text-xl text-scripture/60 leading-[1.8] font-medium italic border-l-4 border-sacred/30 pl-10">
                                    {content.context}
                                </p>
                            </div>
                        )}
                            ...
                            <div className="rounded-[64px] border border-grace/50 bg-white shadow-3xl overflow-hidden">
                                <div className="p-12 border-b border-grace/50 bg-primary-light/10">
                                    <div className="flex items-center space-x-4">
                                        <FingerPrintIcon className="w-8 h-8 text-sacred" />
                                        <h2 className="text-3xl font-bold tracking-tighter uppercase italic">Scholarly <span className="text-ink-light not-italic font-light">Terms.</span></h2>
                                    </div>
                                </div>
                                    ...
                                    <table className="w-full text-left">
                                        <thead>
                                            <tr className="border-b border-grace/50">
                                                <th className="px-12 py-8 text-[11px] font-bold text-ink-muted uppercase italic">Manuscript Term</th>
                                                <th className="px-12 py-8 text-[11px] font-bold text-ink-muted uppercase italic">Source Origin</th>
                                                <th className="px-12 py-8 text-[11px] font-bold text-ink-muted uppercase italic">Linguistic Meaning</th>
                                                <th className="px-12 py-8 text-[11px] font-bold text-ink-muted uppercase italic">Theological Weight</th>
                                            </tr>
                                        </thead>
                                            ...
                                            {content.textualAnalysis.map((word: any, index: number) => (
                                                <tr key={index} className="group hover:bg-primary-light/50 transition-all">
                                                    <td className="px-12 py-10">
                                                        <span className="text-xl font-bold text-scripture group-hover:text-sacred transition-colors uppercase italic">
                                                            {word.phrase || word.originalWord}
                                                        </span>
                                                    </td>
                                                    <td className="px-12 py-10">
                                                        <div className="flex flex-col">
                                                            <span className="text-sm font-bold text-sacred italic">{word.originalWord}</span>
                                ...
                                {content.crossReferences.map((ref: any, index: number) => (
                                    <div key={index} className="p-10 rounded-[48px] border border-grace/50 bg-white group hover:shadow-2xl transition-all">
                                        <div className="flex items-center justify-between mb-8">
                                            <span className="px-4 py-1.5 rounded-lg bg-scripture text-sacred text-[10px] font-bold uppercase shadow-xl">
                                                {ref.reference || ref.verse}
                                            </span>
                                            <BoltIcon className="w-5 h-5 text-sacred group-hover:rotate-12 transition-transform" />
                                        </div>
                    ...
                    <div className="space-y-16">
                        ...
                        {content.opening && (
                            <div className="p-12 md:p-24 rounded-[80px] border border-grace/50 bg-white text-center relative overflow-hidden shadow-3xl">
                                <div className="absolute top-0 left-0 w-64 h-64 bg-scripture/5 blur-[100px] -z-10" />
                                <HeartIcon className="w-16 h-16 text-sacred/30 mx-auto mb-12 animate-pulse" />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            {content.reflections?.map((reflection: any, index: number) => (
                                <div key={index} className="p-12 rounded-[56px] border border-grace/50 bg-white hover:border-sacred/20 transition-all group">
                                    <div className="flex items-center space-x-4 mb-10">
                                        <div className="w-12 h-12 rounded-lg bg-scripture flex items-center justify-center text-white shadow-xl">
                                            <SparklesIcon className="w-6 h-6" />
                                        </div>
                                        <h3 className="text-2xl font-bold tracking-tighter group-hover:text-sacred transition-colors uppercase italic">{reflection.theme}</h3>
                                    </div>
                                    <p className="text-lg text-scripture/60 leading-relaxed font-medium mb-10 italic">
                                        {reflection.content}
                                    </p>
                                    {reflection.personalApplication && (
                                        <div className="p-8 rounded-[32px] bg-primary-light/15 border border-grace/30 italic text-ink-muted font-medium">
                        ...
                        {content.prayerPrompt && (
                            <div className="p-16 rounded-[64px] border border-grace/50 bg-primary-light/10 shadow-3xl text-center">
                                <h3 className="text-xl font-bold text-sacred uppercase tracking-[0.4em] mb-12 italic">Scriptural Response Guidance</h3>
                ...
                {selectedVoice === 'practical' && (
                    <div className="space-y-16">
                        ...
                        <div className="rounded-[64px] border border-grace/50 bg-white shadow-3xl overflow-hidden">
                            <div className="p-12 border-b border-grace/50 bg-primary-light/10">
                                <div className="flex items-center space-x-4">
                                    <BoltIcon className="w-8 h-8 text-sacred" />
                                    <h2 className="text-3xl font-bold tracking-tighter uppercase italic">Scriptural <span className="text-ink-light not-italic font-light">Application.</span></h2>
                                </div>
                            </div>
                            <div className="p-12 grid grid-cols-1 md:grid-cols-2 gap-12">
                                {content.keyQuestions?.map((q: any, index: number) => (
                                    <div key={index} className="p-10 rounded-[48px] border border-grace/30 bg-primary-light/5">
                                        <h3 className="text-xl font-bold text-sacred mb-6 italic tracking-tight uppercase">Q: {q.question}</h3>
                                        ...
                                        {q.application && (
                                            <div className="pt-6 border-t border-grace/50 text-ink-muted text-sm font-medium italic">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            {content.nextSteps?.map((step: any, index: number) => (
                                <div key={index} className="p-10 rounded-[48px] border border-grace/50 bg-white flex flex-col items-center text-center group hover:shadow-2xl transition-all">
                                    <div className="w-16 h-16 rounded-xl bg-scripture text-sacred flex items-center justify-center font-bold text-2xl mb-8 shadow-2xl group-hover:scale-110 transition-transform">
                                        {step.step || index + 1}
                                    </div>
