    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-primary-light border border-sacred/30 rounded-lg p-6 mt-8">
        <div className="flex items-center space-x-2 mb-4">
          <BookOpenIcon className="h-5 w-5 text-sacred" />
          <h3 className="font-display text-lg font-semibold text-scripture">Continue Your Bible Study Journey</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {improvedLinks.map((link, index) => (
            <Link
              key={link.href}
              href={link.href}
              className="flex items-center space-x-3 p-4 bg-white rounded-lg border border-sacred/20 hover:border-sacred/50 hover:bg-sacred-light transition-all duration-200 group shadow-sm"
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center space-x-2 mb-1">
                  <div className="font-semibold text-scripture group-hover:text-gold-dark text-sm truncate">
                    {link.title}
                  </div>
                  <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${BADGE_COLORS[link.type] || 'bg-sacred/10 text-gold-dark'}`}>
              ...
              <div className="flex-shrink-0">
                <span className="w-6 h-6 bg-sacred/10 text-gold-dark rounded-full flex items-center justify-center text-xs font-bold">
                  {index + 1}
                </span>
              </div>
            </Link>
