...
export default function EditorialVerseCard({ reference, text, href, translation = 'KJV', className = '' }: EditorialVerseCardProps) {
  return (
    <div className={`bg-white border-l-4 border-sacred rounded-r-lg p-5 shadow-sm ${className}`}>
      <p className="font-serif text-lg text-scripture leading-relaxed mb-3 italic">
        &ldquo;{text}&rdquo;
      </p>
