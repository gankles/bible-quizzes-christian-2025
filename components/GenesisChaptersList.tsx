        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-center">
          ...
          <div className="flex justify-center gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-ink-muted">Quiz Questions</div>
            </div>
          </div>

          {/* Ultimate Genesis Challenge */}
          <div className="max-w-4xl mx-auto mb-8">
            <div className="bg-blue-50 border border-sacred/20 rounded-lg p-8 text-center">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="bg-sacred/10 text-scripture text-sm font-medium px-2.5 py-0.5 rounded">
      ...
      <div className="bg-scripture text-white py-12">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/genesis-1-quiz"
              className="bg-white text-sacred px-8 py-3 rounded-lg font-semibold hover:bg-primary-light transition-colors"
            >
              Begin with Creation
            </Link>
            <Link
              href="/genesis-quiz"
              className="bg-scripture/80 text-white px-8 py-3 rounded-lg font-semibold hover:bg-sacred-light transition-colors border border-sacred"
            >
