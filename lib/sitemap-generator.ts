...
export function generateAllUrls(): SitemapUrl[] {
  ...
  const staticPages = [
    ...
    { path: '/popular-bible-verses', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/bible-verse-of-the-day', priority: 0.8, changeFreq: 'daily' as const },
    { path: '/random-bible-verse', priority: 0.7, changeFreq: 'monthly' as const },
    { path: '/encouraging-bible-verses', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/short-bible-verses', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/inspirational-bible-verses', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/books-of-the-bible-in-order', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/who-wrote-the-bible', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/bible-verses-about-strength-in-hard-times', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/how-many-chapters-in-the-bible', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/how-to-read-the-bible', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/bible-verses-about-anxiety', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/bible-verses-for-healing-and-strength', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/christmas-bible-verses', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/love-thy-neighbor-bible-verse', priority: 0.8, changeFreq: 'monthly' as const },
    { path: '/ten-commandments', priority: 0.8, changeFreq: 'monthly' as const },
